...
bot.onText(/^\/start/, (msg, match) => {
    bot.sendMessage(msg.chat.id, `Welcome to Real Time Bus. This bot will help you to find the best route you need. \n Enjoy It  ${require('./emoji.js').smillingFace.openMouth}`, { parse_mode: 'HTML' });
    var cmd = require('./cmd/command-match').cmd('/getLocation');
